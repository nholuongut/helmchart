# mychart3 - Helm Upgrade with Chart Versions
...
Observation: Should display latest version of mychart3 from nholuongut helm repo
...
helm install myapp101 nholuongut/mychart3 --version "CHART-VERSION"
helm install myapp101 nholuongut/mychart3 --version "0.1.0"
...
helm upgrade myapp101 nholuongut/mychart3 --version "0.2.0"
...
```t
# Helm Upgrade using Chart Version
helm upgrade myapp101 nholuongut/mychart3
